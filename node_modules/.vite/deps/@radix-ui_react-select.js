...
import {
  ...
  useFocusGuards,
  useId
} from "./chunk-KBITEONG.js";
import {
  clamp,
  useDirection
} from "./chunk-52RF2DXE.js";
import {
...
var Slot2 = React3.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
  ...
  if (slottable) {
    ...
    return (0, import_jsx_runtime3.jsx)(SlotClone2, { ...slotProps, ref: forwardedRef, children: React3.isValidElement(newElement) ? React3.cloneElement(newElement, void 0, newChildren) : null });
  }
  return (0, import_jsx_runtime3.jsx)(SlotClone2, { ...slotProps, ref: forwardedRef, children });
});
Slot2.displayName = "Slot";
var SlotClone2 = React3.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
...
function isSlottable2(child) {
  return React3.isValidElement(child) && child.type === Slottable2;
}
...
var SelectArrow = React6.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.open && contentContext.position === "popper" ? (0, import_jsx_runtime5.jsx)(Arrow, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }
);
